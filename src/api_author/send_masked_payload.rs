...
pub fn send_masked_payload<T: Transport>(author: &mut Author<T>, channel_address: &String, keyload_message_identifier: &String, public_payload: &String, masked_payload: &String) -> Result<Address> 
